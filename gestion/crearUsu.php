...
<div class="container" style='width:80%;'>
	<div id='envio'>
		<center>
			<h1>CREAR USUARIO</h1>
			<form method="post" action="./gestion/guardaUsuario.php">
				<table >
					<tr>
					...
					<tr>
						<td>Nick : </td>
						<td>
						<input type="nick" name="nick" onblur="compruebaNick();" onkeypress="return filtros(this, event);" id="nick" />
						</td>
						<td id="statusNick"></td>
					</tr>
					<tr>
					...
					<tr>
						<td>Teléfono móvil<font color=red>(*)</font> : </td>
						<td>
					...
					<tr>
						<td>Contraseña : </td>
						<td>
						<input type="password" name="pass" onblur='compruebaPass();' id="pass">
						</td>
						<td id="statusPass"></td>
					</tr>
					<tr>
				...
				<div style='text-align: center;'>
					<input type="text" style="display:none;" name="opt" id="opt" value="C" size="1">
					<input type="submit" style="display: none;" value="Crear" id="btnSend" />
					<input type="button" value="Crear" onclick="cifrar()" id="btnEnviar" />
