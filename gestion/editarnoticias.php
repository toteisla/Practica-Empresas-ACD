<div id="containter">
	<?php
			...
			echo "<select id='selectProyecto' onchange='cargaNoticias(this,\"editar\");' >";
		...
		?>
	<div id="sNoticias">
		<select id="selectNoticias">
		<option value=0>--Elige noticia--</option>
		</select>
	</div>
	<div id="noticiero" class='noticiero' style="width:50%; padding: 0 0 0 10px; text-align:left; word-wrap: break-word"><br>
		<div class='divnoticia' id='divnoticia' style='border:1px solid; padding: 15px 15px 15px 15px; visibility:hidden;'>
		</div>
	</div>
</div>
